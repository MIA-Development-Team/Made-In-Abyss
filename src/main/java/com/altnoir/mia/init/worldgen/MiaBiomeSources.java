...
public class MiaBiomeSources {
    public static final DeferredRegister<MapCodec<? extends BiomeSource>> BIOME_SOURCE =
            DeferredRegister.create(Registries.BIOME_SOURCE, MIA.MOD_ID);

    public static final DeferredHolder<
                    MapCodec<? extends BiomeSource>, MapCodec<AbyssNoiseBiomeSource>>
            ABYSS_BIOME_SOURCE =
