...
public class MiaFoliagePlacerTypes {
    public static final DeferredRegister<FoliagePlacerType<?>> FOLIAGE_PLACER_TYPE =
            DeferredRegister.create(BuiltInRegistries.FOLIAGE_PLACER_TYPE, MIA.MOD_ID);

    public static final DeferredHolder<
                    FoliagePlacerType<?>, FoliagePlacerType<InvertedFoliagePlacer>>
            INVERTED_FOLIAGE_PLACER =
                    FOLIAGE_PLACER_TYPE.register(
                            "inverted_foliage_placer",
                            () -> new FoliagePlacerType<>(InvertedFoliagePlacer.CODEC));
    public static final DeferredHolder<
                    FoliagePlacerType<?>, FoliagePlacerType<MegaInvertedFoliagePlacer>>
            MEGA_INVERTED_FOLIAGE_PLACER =
                    FOLIAGE_PLACER_TYPE.register(
                            "mega_inverted_foliage_placer",
                            () -> new FoliagePlacerType<>(MegaInvertedFoliagePlacer.CODEC));
