                            ...
                            CreativeModeTab.builder()
                                    ...
                                    .displayItems(
                                            (parameters, output) -> {
                                                ...
                                                output.accept(
                                                        MiaBlocks.ABYSS_COBBLED_ANDESITE_STAIRS);
                                                output.accept(
                                                        MiaBlocks.ABYSS_COBBLED_ANDESITE_SLAB);
                                                output.accept(
                                                        MiaBlocks.ABYSS_COBBLED_ANDESITE_WALL);
                                                output.accept(
                                                ...
                                                output.accept(
                                                        MiaBlocks.POLISHED_ABYSS_ANDESITE_STAIRS);
                                                output.accept(
                                                        MiaBlocks.POLISHED_ABYSS_ANDESITE_SLAB);
                                                output.accept(
                                                        MiaBlocks.POLISHED_ABYSS_ANDESITE_WALL);
                                                ...
                                                output.accept(
                                                        MiaBlocks.CRACKED_ABYSS_ANDESITE_BRICKS);
                                                output.accept(
                                                        MiaBlocks.ABYSS_ANDESITE_BRICKS_STAIRS);
                                                ...
                                                output.accept(
                                                        MiaBlocks.MOSSY_ABYSS_ANDESITE_BRICKS_WALL);
                                                // 化石树
                                                ...
                                                output.accept(
                                                        MiaBlocks.POLISHED_FOSSILIZED_WOOD_STAIRS);
                                                output.accept(
                                                        MiaBlocks.POLISHED_FOSSILIZED_WOOD_SLAB);
                                                output.accept(
                                                        MiaBlocks.POLISHED_FOSSILIZED_WOOD_WALL);
                                                output.accept(
                                                        MiaBlocks
                                                ...
                                                output.accept(
                                                        MiaBlocks.CHISLED_STRIPPED_FOSSILIZED_WOOD);
                                                output.accept(MiaBlocks.FOSSILIZED_WOOD_BRICKS);
                                                output.accept(
                                                        MiaBlocks.FOSSILIZED_WOOD_BRICKS_STAIRS);
                                                output.accept(
                                                        MiaBlocks.FOSSILIZED_WOOD_BRICKS_SLAB);
                                                output.accept(
                                                        MiaBlocks.FOSSILIZED_WOOD_BRICKS_WALL);
                                                output.accept(
                            ...
                            CreativeModeTab.builder()
                                    ...
                                    .displayItems(
                                            (parameters, output) -> {
                                                ...
                                                output.accept(MiaItems.GRAPPLING_HOOK);
