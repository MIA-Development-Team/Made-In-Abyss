...
public class RegisterEntityRendererEvent {
    public static void register(EntityRenderersEvent.RegisterRenderers event) {
        event.registerBlockEntityRenderer(
                MiaBlockEntities.PEDESTAL_ENTITY.get(), PedestalRenderer::new);
        event.registerBlockEntityRenderer(
                MiaBlockEntities.ABYSS_PORTAL_CORE_ENTITY.get(), AbyssPortalCoreRenderer::new);
        event.registerBlockEntityRenderer(
                MiaBlockEntities.ABYSS_SPAWNER_ENTITY.get(), AbyssSpawnerRenderer::new);
        event.registerBlockEntityRenderer(
                MiaBlockEntities.BRUSHABLE_ENTITY.get(), MiaBrushableRenderer::new);
        event.registerBlockEntityRenderer(
                MiaBlockEntities.ENDLESS_CUP_ENTITY.get(), EndlessCupRenderer::new);
        event.registerBlockEntityRenderer(
                MiaBlockEntities.CAVE_EXPLORER_BEACON_ENTITY.get(),
                CaveExplorerBeaconRenderer::new);
