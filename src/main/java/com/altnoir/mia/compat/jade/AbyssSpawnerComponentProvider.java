...
public enum AbyssSpawnerComponentProvider
    ...
    public void appendTooltip(
            ITooltip tooltip, BlockAccessor blockAccessor, IPluginConfig iPluginConfig) {
        if (!blockAccessor.getServerData().contains(tag)) return;
        ...
        tooltip.add(
                Component.translatable(
                        "tooltip.mia.abyss_spawner.cooldown", MiaUtil.formatTickToTime(cooldown)));
    }
