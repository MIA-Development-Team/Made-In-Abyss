...
public class MiaDensityFunctions {
    ...
    public static final ResourceKey<DensityFunction> THE_ABYSS_ABYSS_PILLARS = theAbyssKey("caves/abyss_pillars");
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstrapContext<DensityFunction> context) {
        ...
        context.register(THE_ABYSS_PILLARS, pillars(holdergetter));
        context.register(THE_ABYSS_ABYSS_PILLARS, DensityFunctions.rangeChoice(
        ...
        context.register(THE_ABYSS_DEPTH, DensityFunctions.rangeChoice(yFunction, -128, 64, DensityFunctions.constant(2.0), the_abyss_depth));
