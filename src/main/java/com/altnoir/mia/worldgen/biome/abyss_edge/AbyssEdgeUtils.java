...
public class AbyssEdgeUtils {
    ...
    public static void abyssGeneration(BiomeGenerationSettings.Builder builder) {
        builder.addFeature(GenerationStep.Decoration.LAKES, AbyssEdgePlacements.LAKE_WATER);
        globalAbyssGenerationNotGeode(builder);
    }


    public static void globalAbyssGeneration(BiomeGenerationSettings.Builder builder) {
        builder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, AbyssEdgePlacements.PRASIOLITE_GEODE);
        globalAbyssGenerationNotGeode(builder);
    }
    ...
    public static void globalAbyssGenerationNotGeode(BiomeGenerationSettings.Builder builder) {
        ...
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, AbyssEdgePlacements.MONSTER_CHEAT);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, AbyssEdgePlacements.SLAB_RUINS);
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, AbyssEdgePlacements.SUN_STONE);
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AbyssEdgePlacements.VINES);
    ...
    public static void addMeadowVegetation(BiomeGenerationSettings.Builder builder) {
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AbyssEdgePlacements.PATCH_GRASS_PLAIN);
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AbyssEdgePlacements.FLOWER_MEADOW);
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AbyssEdgePlacements.FOREST_FLOWERS);
    }
    ...
    public static void addDefaultUndergroundVariety(BiomeGenerationSettings.Builder builder) {
        ...
        builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AbyssEdgePlacements.GLOW_LICHEN);
    }
    ...
    public static void addDefaultSprings(BiomeGenerationSettings.Builder builder) {
        builder.addFeature(GenerationStep.Decoration.FLUID_SPRINGS, AbyssEdgePlacements.SPRING_WATER);
    }
