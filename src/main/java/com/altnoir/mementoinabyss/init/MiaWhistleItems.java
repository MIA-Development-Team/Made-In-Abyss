...
public final class MiaWhistleItems {
    ...
    public static final ItemEntry<WhistleItem> RED_WHISTLE =
            REGISTRATE
                    .item(
                            "red_whistle",
                            properties -> new WhistleItem(properties, WhistleGrid.RED_WHISTLE))
                    .register();

    public static final ItemEntry<EchoReedItem> ECHO_REED =
            REGISTRATE
                    .item(
                            "echo_reed",
                            properties ->
                                        ...
                                        var model =
                                                ModelTemplates.FLAT_ITEM.create(
                                                        ...
                                                        TextureMapping.layer0(
                                                                new Material(
                                                                        provider.modLoc(
                                                                                "item/skill/artifact_haste"))),
                                                        provider.modelOutput);
                                        provider.createWithExistingModel(context.getEntry(), model);
                                    })
                    .register();

    public static final ItemEntry<WhistleAmplifierItem> RESONANCE_PRESSURE_FRAGMENT =
            REGISTRATE
                    .item(
                            "resonance_pressure_fragment",
                            properties ->
                                    new WhistleAmplifierItem(
                                            properties,
