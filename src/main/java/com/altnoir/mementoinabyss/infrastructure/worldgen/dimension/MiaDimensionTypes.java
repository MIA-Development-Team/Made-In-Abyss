...
public final class MiaDimensionTypes {
    ...
    public static final ResourceKey<DimensionType> THE_ABYSS =
            ResourceKey.create(
                    Registries.DIMENSION_TYPE, MementoInAbyss.asResource("the_abyss_type"));
    public static final ResourceKey<DimensionType> GREAT_FAULT =
            ResourceKey.create(
    ...
    public static void bootstrap(BootstrapContext<DimensionType> context) {
        ...
        var attributes =
                EnvironmentAttributeMap.builder()
                        ...
                        .set(
                                NeoForgeEnvironmentAttributes.CUSTOM_SKYBOX,
