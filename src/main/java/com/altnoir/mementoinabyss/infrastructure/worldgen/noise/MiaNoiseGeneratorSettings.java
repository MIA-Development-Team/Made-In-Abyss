...
public final class MiaNoiseGeneratorSettings {
    private static final NoiseSettings THE_ABYSS_NOISE_SETTINGS =
            NoiseSettings.create(MiaHeight.THE_ABYSS.minY(), MiaHeight.THE_ABYSS.height(), 2, 1);
    ...
    public static final ResourceKey<NoiseGeneratorSettings> THE_ABYSS =
            ResourceKey.create(Registries.NOISE_SETTINGS, MementoInAbyss.asResource("the_abyss"));
    public static final ResourceKey<NoiseGeneratorSettings> GREAT_FAULT =
            ResourceKey.create(Registries.NOISE_SETTINGS, MementoInAbyss.asResource("great_fault"));
