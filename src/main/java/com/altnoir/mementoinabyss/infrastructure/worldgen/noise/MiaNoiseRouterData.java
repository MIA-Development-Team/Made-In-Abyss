...
public class MiaNoiseRouterData extends NoiseRouterData {
    ...
    public static final ResourceKey<DensityFunction> BASE_3D_NOISE_OVERWORLD =
            createKey("overworld/base_3d_noise");
    public static final ResourceKey<DensityFunction> BASE_3D_NOISE_NETHER =
            createKey("nether/base_3d_noise");
    public static final ResourceKey<DensityFunction> BASE_3D_NOISE_END =
            createKey("end/base_3d_noise");
    public static final ResourceKey<DensityFunction> CONTINENTS = createKey("overworld/continents");
    public static final ResourceKey<DensityFunction> EROSION = createKey("overworld/erosion");
    public static final ResourceKey<DensityFunction> RIDGES = createKey("overworld/ridges");
    public static final ResourceKey<DensityFunction> RIDGES_FOLDED =
            createKey("overworld/ridges_folded");
    ...
    public static final ResourceKey<DensityFunction> ENTRANCES =
            createKey("overworld/caves/entrances");
    ...
    private static ResourceKey<DensityFunction> createKey(String location) {
        return ResourceKey.create(
                Registries.DENSITY_FUNCTION, Identifier.withDefaultNamespace(location));
    }
    ...
    private static DensityFunction theAbyssDensity(HolderGetter<DensityFunction> densityFunctions) {
        ...
        DensityFunction abyssGreatCave =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_GREAT_CAVE);

        DensityFunction abyssHole =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_HOLE_ABOVE);
        DensityFunction abyssBigHole =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_BIG_HOLE);

        DensityFunction insideAbyssHoleB =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_INSIDE_HOLE_BELOW);
        DensityFunction insideAbyssHoleA =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_INSIDE_HOLE_ABOVE);

        DensityFunction middleAbyssNoise =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_MIDDLE_BASE_3D);
        DensityFunction outsideAbyssNoise =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_OUTSIDE_BASE_3D);
        DensityFunction abyssPillars =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_PILLARS);

        DensityFunction rangeChoice2 =
                DensityFunctions.rangeChoice(
                        abyssBigHole, -1000000.0, 0.025, middleAbyssNoise, outsideAbyssNoise);

        DensityFunction layer2 =
                DensityFunctions.add(DensityFunctions.constant(0.2), abyssGreatCave);
        DensityFunction layer =
                DensityFunctions.rangeChoice(
                        yFunction,
                        -128.0,
        ...
        DensityFunction rangeChoice =
                DensityFunctions.rangeChoice(abyssHole, -1000000.0, 0.025, rangeChoice1, layer);

        DensityFunction ycg1 =
                DensityFunctions.yClampedGradient(
                        MiaHeight.THE_ABYSS.maxY() - 64, MiaHeight.THE_ABYSS.maxY(), 1, 1);
        ...
        DensityFunction ycg2 = DensityFunctions.yClampedGradient(-160, -120, 0, 1);
    ...
    private static DensityFunction greatFaultDensity(
            HolderGetter<DensityFunction> densityFunctions) {
        DensityFunction yFunction = getFunction(densityFunctions, MiaNoiseRouterData.Y);

        DensityFunction abyssHoleAbove =
                getFunction(densityFunctions, MiaDensityFunctions.GREAT_FAULT_HOLE_ABOVE);
        DensityFunction abyssHoleBelow =
                getFunction(densityFunctions, MiaDensityFunctions.GREAT_FAULT_HOLE_BELOW);

        DensityFunction rangeChoice =
                DensityFunctions.rangeChoice(
                        yFunction,
                        MiaHeight.GREAT_FAULT.minY(),
                        MiaHeight.GREAT_FAULT.maxY() - 64,
                        abyssHoleBelow,
                        abyssHoleAbove);

        DensityFunction yc1 =
                DensityFunctions.yClampedGradient(
                        MiaHeight.GREAT_FAULT.maxY() - 64, MiaHeight.GREAT_FAULT.maxY(), 1, 0);
        DensityFunction add1 = DensityFunctions.add(DensityFunctions.constant(1.025), rangeChoice);
        ...
        DensityFunction yc2 =
                DensityFunctions.yClampedGradient(
                        MiaHeight.GREAT_FAULT.minY(), MiaHeight.GREAT_FAULT.minY() + 64, 0, 1);
        DensityFunction add3 = DensityFunctions.add(DensityFunctions.constant(0.4), add2);
    ...
    private static NoiseRouter theAbyssRouter(
            HolderGetter<DensityFunction> densityFunctions,
            HolderGetter<NormalNoise.NoiseParameters> noiseParameters) {
        DensityFunction yFunction = getFunction(densityFunctions, MiaNoiseRouterData.Y);
        DensityFunction normalFloodedness =
                theAbyssFluidLevel(
                        noiseParameters,
                        ...
                        0.5,
                        yFunction);
        DensityFunction sparseFloodedness =
                DensityFunctions.rangeChoice(
                        MiaDensityFunctionTypes.sparseAquifer(10),
                        0.0,
                        2.0,
                        normalFloodedness,
        ...
        DensityFunction idwj1 =
                DensityFunctions.rangeChoice(
                        yFunction,
                        -128,
                        5,
                        MiaDensityFunctionTypes.general(0.0F, 0.25F),
                        MiaDensityFunctionTypes.hopper());
        ...
        DensityFunction idwj4 =
                slide(idwj3, -64, MiaHeight.THE_ABYSS.maxY(), 72, 0, -0.078125, 0, 24, 0.1171875);

        DensityFunction greatCaveNoodle =
                getFunction(densityFunctions, MiaDensityFunctions.THE_ABYSS_GREAT_CAVE_NOODLE);
        DensityFunction noodle =
                DensityFunctions.add(
                        ...
                        DensityFunctions.add(
                                ...
                                getFunction(
                                        densityFunctions, MiaDensityFunctions.THE_ABYSS_NOODLE)));
        DensityFunction combinedDensity =
                DensityFunctions.max(
                        DensityFunctions.min(theAbyssDensity(densityFunctions), noodle),
                        greatCaveNoodle);
        ...
        return new NoiseRouter(
                ...
                getFunction(
                        densityFunctions, MiaDensityFunctions.THE_ABYSS_DEPTH), // depth 生物群系深度函数。
                getFunction(densityFunctions, RIDGES), // ridges 生物群系奇异度函数。
                idwj4, // initial_density_without_jaggedness//
                // 预处理地表高度，影响表面规则的含水层的放置。游戏会从世界顶部以4*整型noise.size_vertical的精度向下查找，将首个大于25/64的值的高度作为预处理地表高度。
    ...
    private static NoiseRouter greatFaultRouter(
            HolderGetter<DensityFunction> densityFunctions,
            HolderGetter<NormalNoise.NoiseParameters> noiseParameters) {
        DensityFunction yFunction = getFunction(densityFunctions, MiaNoiseRouterData.Y);
        DensityFunction fluidLevelFloodedness =
                ...
                DensityFunctions.min(
                        ...
                        DensityFunctions.add(
                                DensityFunctions.interpolated(
                                        getFunction(
                                                densityFunctions,
                                                MiaDensityFunctions.GREAT_FAULT_BIG_CAVE)),
                                DensityFunctions.constant(-0.15)));
        DensityFunction finalDensity =
                DensityFunctions.min(greatFaultDensity(densityFunctions), noodle);
    ...
    private static DensityFunction theAbyssFluidLevel(
            HolderGetter<NormalNoise.NoiseParameters> noiseParameters,
            ResourceKey<NormalNoise.NoiseParameters> noiseKey,
            double xzScale,
            double yScale,
            DensityFunction yFunction) {
        DensityFunction noise =
                DensityFunctions.noise(noiseParameters.getOrThrow(noiseKey), xzScale, yScale);
