...
public final class MiaDimensions {
    public static final ResourceKey<LevelStem> THE_ABYSS =
            ResourceKey.create(Registries.LEVEL_STEM, MementoInAbyss.asResource("the_abyss"));
    public static final ResourceKey<Level> THE_ABYSS_LEVEL =
            ResourceKey.create(Registries.DIMENSION, MementoInAbyss.asResource("the_abyss"));
    public static final ResourceKey<LevelStem> GREAT_FAULT =
            ResourceKey.create(Registries.LEVEL_STEM, MementoInAbyss.asResource("great_fault"));
    public static final ResourceKey<Level> GREAT_FAULT_LEVEL =
            ResourceKey.create(Registries.DIMENSION, MementoInAbyss.asResource("great_fault"));
    ...
    public static void bootstrap(BootstrapContext<LevelStem> context) {
        ...
        Climate.ParameterList<Holder<Biome>> outside =
                new Climate.ParameterList<>(
                        List.of(
                                biomePair(
                                        ...
                                        0.3F,
                                        0.5F,
                                        biomes.getOrThrow(MiaBiomes.SKYFOG_FOREST)),
                                biomePair(
                                        -0.5F,
                                        0.5F,
                                        0.0F,
                                        ...
                                        0.5F,
                                        0.8F,
                                        biomes.getOrThrow(MiaBiomes.DENSE_SKYFOG_FOREST)),
                                biomePair(
                                        -1.0F,
                                        0.0F,
                                        0.0F,
                                        ...
                                        -0.6F,
                                        -0.4F,
                                        biomes.getOrThrow(MiaBiomes.FOSSILIZED_FOREST)),
                                biomePair(
                                        -1.0F,
                                        0.0F,
                                        0.0F,
                                        ...
                                        -0.9F,
                                        -0.6F,
                                        biomes.getOrThrow(MiaBiomes.RICH_FOSSILIZED_FOREST)),
                                biomePair(
                                        -0.5F,
                                        0.5F,
                                        0.2F,
                                        ...
                                        -0.6F,
                                        -0.4F,
                                        biomes.getOrThrow(MiaBiomes.UNDER_FOSSILIZED_FOREST)),
                                biomePair(
                                        -0.5F,
                                        0.5F,
                                        0.1F,
                                        ...
                                        0.15F,
                                        0.2F,
                                        biomes.getOrThrow(MiaBiomes.ABYSS_LUSH_CAVES)),
                                biomePair(
                                        -0.5F,
                                        0.0F,
                                        0.4F,
                                        ...
                                        0.2F,
                                        0.3F,
                                        biomes.getOrThrow(MiaBiomes.ABYSS_DRIPSTONE_CAVES)),
                                biomePair(
                                        -0.3F,
                                        0.5F,
                                        0.7F,
                                        ...
                                        0.3F,
                                        0.45F,
                                        biomes.getOrThrow(MiaBiomes.PRASIOLITE_CAVES)),
                                biomePair(
                                        -1.0F,
                                        1.0F,
                                        1.85F,
                                ...
                                biomePair(
                                        ...
                                        -0.5F,
                                        0.5F,
                                        biomes.getOrThrow(MiaBiomes.INVERTED_FOREST)),
                                biomePair(
                                        -1.0F,
                                        1.0F,
                                        -1.0F,
                                        ...
                                        -0.2F,
                                        0.2F,
                                        biomes.getOrThrow(MiaBiomes.ABYSS_PLAINS))));

        Climate.ParameterList<Holder<Biome>> inside =
                new Climate.ParameterList<>(
                        List.of(
                                biomePair(
                                        -1.0F,
                                        ...
                                        -1.0F,
                                        1.0F,
                                        biomes.getOrThrow(MiaBiomes.THE_ABYSS)),
                                biomePair(
                                        -1.0F,
                                        1.0F,
                                        1.9F,
        ...
        context.register(
                THE_ABYSS,
                new LevelStem(dimensionTypes.getOrThrow(MiaDimensionTypes.THE_ABYSS), generator));

        Climate.ParameterList<Holder<Biome>> greatFaultOutside =
                new Climate.ParameterList<>(
                        List.of(
                                biomePair(
                                        -1.0F,
        ...
        NoiseBasedChunkGenerator greatFaultGenerator =
                new NoiseBasedChunkGenerator(
                        AbyssNoiseBiomeSource.createFromList(
                                112,
                                greatFaultOutside,
                                biomes.getOrThrow(MiaBiomes.THE_GREAT_FAULT)),
                        noiseSettings.getOrThrow(MiaNoiseGeneratorSettings.GREAT_FAULT));
        context.register(
                GREAT_FAULT,
                new LevelStem(
                        dimensionTypes.getOrThrow(MiaDimensionTypes.GREAT_FAULT),
                        greatFaultGenerator));
    }
