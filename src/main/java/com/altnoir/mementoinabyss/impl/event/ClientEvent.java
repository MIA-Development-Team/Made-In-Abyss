...
public final class ClientEvent {
    ...
    @SubscribeEvent
    public static void registerEnvironmentRenderers(
            RegisterCustomEnvironmentEffectRendererEvent event) {
        event.registerSkyboxRenderer(
                EnvironmentCubeSkyboxRenderer.ID, EnvironmentCubeSkyboxRenderer.INSTANCE);
    }
    ...
    public static void clientTick(ClientTickEvent.Pre event) {
        ...
        if (player != null) {
            ...
            RopeClimbing.tick(
                    player,
                    RopeConnectorBlockEntity.clientInstances(),
                    input.jump(),
                    input.shift());
        }
    }
    ...
    public static void registerPayloadHandlers(RegisterClientPayloadHandlersEvent event) {
        ...
        event.register(
                CrossDimensionLodBatchPayload.TYPE,
                (payload, context) -> CrossDimensionLodRenderer.accept(payload));
        event.register(
                CrossDimensionLodDebugPayload.TYPE,
    ...
    public static void registerDebugEntries(RegisterDebugEntriesEvent event) {
        ...
        event.includeInProfile(
                id, DebugScreenProfile.PERFORMANCE, DebugScreenEntryStatus.IN_OVERLAY);
    }
