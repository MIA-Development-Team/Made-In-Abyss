...
public record PlacedWhistleFragment(
        ItemStackTemplate fragment, int x, int y, GridRotation rotation) {
    public static final Codec<PlacedWhistleFragment> CODEC =
            RecordCodecBuilder.create(
                    instance ->
                            instance.group(
                                            ItemStackTemplate.CODEC
                                                    .fieldOf("fragment")
                                                    .forGetter(PlacedWhistleFragment::fragment),
                                            Codec.intRange(0, 15)
                                                    .fieldOf("x")
                                                    .forGetter(PlacedWhistleFragment::x),
                                            Codec.intRange(0, 15)
                                                    .fieldOf("y")
                                                    .forGetter(PlacedWhistleFragment::y),
                                            GridRotation.CODEC
                                                    .optionalFieldOf("rotation", GridRotation.NONE)
    ...
    public static PlacedWhistleFragment of(ItemStack stack, int x, int y, GridRotation rotation) {
        return new PlacedWhistleFragment(
                ItemStackTemplate.fromNonEmptyStack(stack.copyWithCount(1)), x, y, rotation);
    }
