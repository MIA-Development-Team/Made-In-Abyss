...
public final class ArtifactEnhancementComponent implements ArtifactItemComponent {
    ...
    public void appendTooltip(
        ...
        int level =
                stack.getOrDefault(
                                MiaDataComponents.ARTIFACT_ENHANCEMENT.get(),
                                ArtifactEnhancement.EMPTY)
                        .level();
        if (level >= profile.maxEnhancementLevel()) {
            tooltip.add(
                    Component.translatable("tooltip.mementoinabyss.artifact.enhancement.max")
            ...
            tooltip.add(
                    Component.translatable(
                                    ...
                                    Component.literal(
                                                    Integer.toString(profile.maxEnhancementLevel()))
                                            .withStyle(ChatFormatting.YELLOW))
                            .withStyle(ChatFormatting.GOLD));
        }
        ...
        for (ArtifactAttribute attribute : enhancement.attributes()) {
            ...
            tooltip.add(
                    Component.translatable(
                                    ...
                                    Component.translatable(
                                            attribute.attribute().value().getDescriptionId()))
