...
public final class WhistleFragmentTooltipModifier implements TooltipModifier {
    public static final WhistleFragmentTooltipModifier INSTANCE =
            new WhistleFragmentTooltipModifier();
    ...
    public void modify(ItemTooltipEvent event) {
        ...
        if (definition.unique()) {
            event.getToolTip()
                    .add(
                            Component.translatable("tooltip.mementoinabyss.whistle.fragment.unique")
                                    .withStyle(TooltipPalette.MIA.highlight()));
        }
