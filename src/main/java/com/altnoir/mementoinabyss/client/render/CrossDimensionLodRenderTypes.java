...
public final class CrossDimensionLodRenderTypes {
    ...
    public static final VertexFormat LOD_VERTEX_FORMAT =
     ...
     */
    public static final VertexFormat IRIS_VERTEX_FORMAT =
            VertexFormat.builder()
                    .add("Position", VertexFormatElement.POSITION)
                    .add("Color", VertexFormatElement.COLOR)
    ...
    private static final RenderPipeline TILED_BLOCKS_PIPELINE =
            RenderPipeline.builder(RenderPipelines.MATRICES_FOG_SNIPPET)
                    ...
                    .build();
    private static final RenderPipeline IRIS_BLOCKS_PIPELINE =
            RenderPipeline.builder(RenderPipelines.MATRICES_FOG_SNIPPET)
