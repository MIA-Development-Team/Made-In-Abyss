...
public final class MiaTreeFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
                ...
                new ConfiguredFeature<>(
                        ...
                        new TreeConfiguration.TreeConfigurationBuilder(
                                        ...
                                        new FancyFoliagePlacer(
                                                ConstantInt.of(3), ConstantInt.of(1), 4),
        ...
        context.register(
                ...
                new ConfiguredFeature<>(
                        ...
                        new HugeMushroomFeatureConfiguration(
                                ...
                                BlockStateProvider.simple(MiaBlocks.VERDANT_STEM.get()),
                                3,
        ...
        context.register(
                INVERTED_TREE,
                new ConfiguredFeature<>(
                        MiaWorldgenFeatures.INVERTED_TREE.get(), inverted(10, 2, 3, 3)));
        context.register(
                MEGA_INVERTED_TREE,
                new ConfiguredFeature<>(
                        MiaWorldgenFeatures.INVERTED_TREE.get(), inverted(16, 3, 6, 5)));
    }
    ...
    private static WeightedStateProvider skyfogLeaves(int normalWeight, int fruitWeight) {
        return new WeightedStateProvider(
                WeightedList.<BlockState>builder()
                        ...
                        .add(
                                MiaBlocks.SKYFOG_LEAVES_WITH_FRUITS.get().defaultBlockState(),
                                fruitWeight));
    }

    private static TreeConfiguration inverted(
            int baseHeight, int randomA, int randomB, int radius) {
        return new TreeConfiguration.TreeConfigurationBuilder(
    ...
    private static ResourceKey<ConfiguredFeature<?, ?>> key(String name) {
        return ResourceKey.create(
                Registries.CONFIGURED_FEATURE, MementoInAbyss.asResource("tree/" + name));
    }
