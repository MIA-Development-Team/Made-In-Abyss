...
public final class MiaJigsawStructure extends Structure {
    ...
    public static final MapCodec<MiaJigsawStructure> CODEC = RecordCodecBuilder.<MiaJigsawStructure>mapCodec(
            instance -> instance.group(
                    ...
                    CaveFloorSearch.CODEC.optionalFieldOf("cave_floor_search").forGetter(s -> s.caveFloorSearch),
                    VerticalAnchor.CODEC.optionalFieldOf("max_start_y_exclusive").forGetter(s -> s.maxStartYExclusive),
    ...
    public MiaJigsawStructure(StructureSettings settings, Holder<StructureTemplatePool> startPool,
                              ...
                              JigsawStructure.MaxDistance maxDistance, List<PoolAliasBinding> poolAliases,
                              DimensionPadding dimensionPadding, LiquidSettings liquidSettings) {
        this(settings, startPool, startJigsawName, maxDepth, startHeight, useExpansionHack,
                projectStartToHeightmap, caveFloorSearch, Optional.empty(), maxDistance, poolAliases,
    ...
    public MiaJigsawStructure(StructureSettings settings, Holder<StructureTemplatePool> startPool,
                              ...
                              DimensionPadding dimensionPadding, LiquidSettings liquidSettings) {
        this(settings, startPool, startJigsawName, maxDepth, startHeight, useExpansionHack,
                projectStartToHeightmap, Optional.empty(), Optional.empty(), maxDistance, poolAliases,
                dimensionPadding, liquidSettings);
    }
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        Optional<BlockPos> start = caveFloorSearch.isPresent()
        ...
        Optional<GenerationStub> generation = JigsawPlacement.addPieces(context, startPool, startJigsawName, maxDepth,
                blockPos, useExpansionHack, projectStartToHeightmap, maxDistance,
                PoolAliasLookup.create(poolAliases, blockPos, context.seed()), dimensionPadding, liquidSettings);
