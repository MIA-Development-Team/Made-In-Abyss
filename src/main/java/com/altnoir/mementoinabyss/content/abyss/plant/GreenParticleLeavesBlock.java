...
public class GreenParticleLeavesBlock extends LeavesBlock {
    ...
    public static final MapCodec<GreenParticleLeavesBlock> CODEC =
    ...
    public GreenParticleLeavesBlock(
    ...
    protected void spawnFallingLeavesParticle(Level level, BlockPos pos, RandomSource random) {
        ColorParticleOption particle =
                ColorParticleOption.create(ParticleTypes.TINTED_LEAVES, LEAF_PARTICLE_COLOR);
