...
public class FruitingSkyfogLeavesBlock extends GreenParticleLeavesBlock {
    public static final MapCodec<FruitingSkyfogLeavesBlock> CODEC =
    ...
    public FruitingSkyfogLeavesBlock(
            float leafParticleChance, BlockBehaviour.Properties properties) {
    ...
    private InteractionResult harvest(BlockState state, Level level, BlockPos pos, Player player) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            ...
            popResource(
                    ...
                    pos,
                    new ItemStack(
                            MiaItems.MISTFUZZ_PEACH.get(), 1 + serverLevel.getRandom().nextInt(2)));
            ...
            serverLevel.gameEvent(
                    GameEvent.BLOCK_CHANGE, pos, GameEvent.Context.of(player, harvestedState));
        }
