...
public class WaterTallFlowerBlock extends WaterDoublePlantBlock implements BonemealableBlock {
    public WaterTallFlowerBlock(Properties properties) { super(properties); }
    ...
    @Override public void performBonemeal(ServerLevel level, RandomSource random, BlockPos pos, BlockState state) { popResource(level, pos, new ItemStack(this)); }
}
